...
import { ReadReceiptAvatars } from "../../ui/ReadReceiptAvatars";

interface MessageItemGroupReadReceiptSlotProps {
  isGroupChat: boolean;
...
export function MessageItemGroupReadReceiptSlot({
  isGroupChat,
  layout,
  readReceiptAvatars,
  onReadReceiptSlotClick,
}: MessageItemGroupReadReceiptSlotProps) {
  if (!isGroupChat) {
    return null;
  }
